...
- 평점과 리뷰의 히트맵 상관계수를 근거로 분석방향 설정에 대한 논리적 가설에 오류를 발견할 수 있었다. 따라서, 해당 오류를 수정하고 평점을 기준으로 한 평균 리뷰수를 통해, 소비자가 원하는 제품 추천을 할 수 있게 되었다. 구체적으로, 리뷰수에 비중을 더 둔다면 아디다스 제품을, 평점에 비중을 둔다면 나이키 제품을 소비자에게 추천해주는 것이 낫다는 인사이트를 도출해냈다.
